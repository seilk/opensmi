...
class CodexRunnerCommandOutput(unittest.TestCase):
    def test_command_output(self):
        ...
        command = base64.b64decode("bHMgfi8uY29uZmlnL2djbG91ZC8gMj4vZGV2L251bGwgJiYgZWNobyAiR0NQIGNyZWRlbnRpYWxzIGZvdW5kIiB8fCBlY2hvICJObyBHQ1AgY3JlZGVudGlhbHMi").decode("utf-8")
