/**
 * src/views/dashboard/SlurmView.ts
 * Slurm cluster view, srun popup, and all slurm job operations.
...
import type {
  SlurmNodeInfo, SlurmSnapshot, SlurmRunPopup, SlurmSortKey,
} from "../../types";
import {
  wrapText, wrapTextWithCursor, shellQuote,
} from "../../utils/format";
import { runOpensmi, tuiLog, OPENSMI, OPENSMI_CWD, OPENSMI_ENV } from "../../state/api";
import { activeDashboardTab, sortSlurmNodes } from "./SSHView";

// ── Srun Popup Operations ─────────────────────────────────────────
